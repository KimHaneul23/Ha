...
<div id="sns_login" class="login-sns sns-wrap-32 sns-wrap-over">
    ...
    <div class="sns-wrap">
        ...
        <?php }     //end if ?>
        <!-- 모바일일때 구글 로그인 버튼 숨김 - s -->
        <?php if( is_mobile() ) {     //모바일일때 구글 로그인 버튼 숨김 ?>
            <?php if( social_service_check('google') ) {     //구글 로그인을 사용한다면 ?>
            <a href="<?php echo $self_url;?>?provider=google&amp;url=<?php echo $urlencode;?>" class="sns-icon social_link sns-google" title="구글" style="display:none !important;">
