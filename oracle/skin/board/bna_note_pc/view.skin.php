...
<article id="bo_v">
<div style="width:1120px; position:relative; margin:0 auto;">
<div style="width:200px; height:200px; top:140px; position:absolute; z-index:10; background:url('<?php echo $board_skin_url?>/img/bna_arrow.png'); <?php if($view['wr_3'] == 'mode_2') { echo 'display:none'; } ?>" id="allow"></div>
...
<div style="width:200px; height:200px; top:140px; left:500px; position:absolute; z-index:10; background:url('<?php echo $board_skin_url?>/img/bna_arrow2.png'); <?php if($view['wr_3'] == 'mode_1') { echo 'display:none'; } ?>" id="allow2"></div>
	...
	<div id="bo_v_wrap" style="width:1120px;">
		...
		<div id="bo_v_be_af" style="<?php if($view['wr_3'] == 'mode_1') { echo 'display:none'; } ?>">
			<div id="bo_v_img2" style="width:1120px;overflow:hidden;zoom:1;position:relative;margin:0 auto; border:1px solid black; text-align:center;">										
				<?php 
		...
		<!-- 본문 내용 시작 { -->
			...
			<div style="position:relative; width:560px; text-align:center; background-color: rgba(0, 0, 0, 0.8); color:white;  padding: 17px 0; float:left;">
				Before
			</div>
			<div style="position:relative; width:560px; border-left:1px solid #4c4c4c; box-sizing:border-box; text-align:center; background-color: rgba(0, 0, 0, 0.8); color:white;  padding: 17px 0; float:left;">
				After [ <?php echo $view['wr_5']?> ]
			</div>
			<div style="clear:both;"></div>
			<div style="width:1120px; margin:0 auto; border-top:1px solid #4c4c4c;">
				<div id="bo_v_con">
