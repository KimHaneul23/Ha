...
<div style="width:200px; height:200px; top:180px; position:absolute; z-index:10; background:url('<?php echo $board_skin_url?>/img/bna_arrow.png'); <?php if($view['wr_3'] == 'mode_2') { echo 'display:none'; } ?>" id="allow"></div>
<div style="width:200px; height:200px; top:180px; left:500px; position:absolute; z-index:10; background:url('<?php echo $board_skin_url?>/img/bna_arrow2.png'); <?php if($view['wr_3'] == 'mode_1') { echo 'display:none'; } ?>" id="allow2"></div>
</div>
	...
	<div id="bo_v_wrap">
		...
		<div id="bo_v_be_af" style="<?php if($view['wr_3'] == 'mode_1') { echo 'display:none'; } ?>">
			<div id="bo_v_img2" style="width:1120px;overflow:hidden;zoom:1;position:relative;margin:0 auto; border:1px solid black;">										
				<?php 
