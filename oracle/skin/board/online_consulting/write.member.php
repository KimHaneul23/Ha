...
<section id="bo_w" >
    ...
    <div class="bbs_head02 bbs_wrap">
		...
		<tr>
            ...
            <td <?php if($is_admin) echo "colspan='3'"; ?>><input type="text" name="wr_name" value="<?php echo $member['mb_name'] ?>" id="wr_name" required class="frm_input required" size="29" maxlength="20"></td>
        </tr>
		<?php } ?>
		<?php if ($is_password) { ?>
        <tr>
		...
		<tr>
			...
			<td>
				...
				<input type="input" name="wr_4" id="wr_4" class="frm_input" size="10" value="<?php echo $write['wr_4']; ?>" maxlength="4" required>

				<?php } ?>
				<input type="checkbox" id="wr_11" name="wr_11" value="Y" checked <?php if($write['wr_11'] == 'Y') echo "checked='checked'";?> style="border:0">
        ...
        <tr>
            ...
            <td <?php if($is_admin) echo "colspan='3'"; ?>>
				...
				<input type="checkbox" id="wr_12" name="wr_12" value="Y" > 
