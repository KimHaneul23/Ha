...
-->
<link rel="stylesheet" href="<?php echo G5_SKIN_URL;?>/board/online_consulting/style.css">
<div id="bo_title">
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bbs_head01 bbs_wrap">
        ...
        for ($i=0; $i<count($list); $i++) {
         ?>
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>" <?php if($list[$i]['wr_7'] == '미답변'){ echo "style='background:#fefcf3'"; }?>>
            <?php if ($is_checkbox) { ?>
            <td class="td_chk">
            ...
            <td class="td_subject">
				...
				?>
                <a href="<?php echo G5_URL ?>/admin/bbs/write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?php echo $list[$i]['wr_id'] ?>&page=<?=$page?>&sst=<?=$sst?>&sfl=<?=$sfl?>&stx=<?=$stx?>">
			...
			<td class="td_num">
				<?php
				if($list[$i]['wr_7'] == '미답변'){
					echo "<font style='color:#fe1266'>".$list[$i]['wr_7']."</font>";
				} else {
					echo $list[$i]['wr_7'];
				}
				?>
			...
			<td class="td_setting">
				<a href="<?php echo G5_URL ?>/admin/bbs/write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?php echo $list[$i]['wr_id'] ?>&page=<?=$page?>&sst=<?=$sst?>&sfl=<?=$sfl?>&stx=<?=$stx?>&type=2"><img src="<?php echo G5_URL ?>/img/db_modify.png" alt="수정"></a> / <img src="<?php echo G5_URL ?>/img/db_delete.png" alt="삭제" onclick="wr_id_delete('<?php echo $list[$i]['wr_id']; ?>')" style="cursor:pointer"/>
			</td>
        </tr>
        <?php } ?>
    ...
    <div class="bo_fx">
        <?php if ($is_checkbox) { ?>
        <ul class="btn_bo_adm">
            <li><input type="image" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value" src="<?php echo G5_URL ?>/img/chk_delete.png" alt="선택삭제"></li>
			<!--
