...
<section id="bo_w">
    ...
    <div class="bbs_head02 bbs_wrap">
		...
		<tr>
            ...
            <td <?php if($is_admin) echo "colspan='3'"; ?>><input type="text" name="wr_name" value="<?php echo $member['mb_nick'] ?>" id="wr_name" required class="frm_input required" size="29" maxlength="20"></td>
        </tr>
        <tr>
			<?php if($is_admin){ ?>
		...
		<tr>
			<?php if($is_admin){ ?>
				...
				<td class="td_half">
					...
					<input type="input" name="wr_2" id="wr_2" class="frm_input" size="10" value="<?php echo $member_hp[1]; ?>" maxlength="4" size="7">&nbsp;&nbsp;-&nbsp;&nbsp;
					<input type="input" name="wr_3" id="wr_3" class="frm_input" size="10" value="<?php echo $member_hp[2]; ?>" maxlength="4" size="7">
					...
					<input type="input" name="wr_2" id="wr_2" class="frm_input" size="10" value="<?php echo $write['wr_2']; ?>" maxlength="4" required>&nbsp;&nbsp;-&nbsp;&nbsp;
					<input type="input" name="wr_3" id="wr_3" class="frm_input" size="10" value="<?php echo $write['wr_3']; ?>" maxlength="4" required>
			...
			<?php } else { ?>
				...
				<td>
					...
					<input type="input" name="wr_2" id="wr_2" class="frm_input" size="10" value="<?php echo $member_hp[1]; ?>" maxlength="4">&nbsp;&nbsp;-&nbsp;&nbsp;
					<input type="input" name="wr_3" id="wr_3" class="frm_input" size="10" value="<?php echo $member_hp[2]; ?>" maxlength="4">
        ...
        <tr>
            ...
            <td <?php if($is_admin) echo "colspan='3'"; ?>>
				...
				for($c=0; $c<$cnt; $c++){
					...
					echo "><span class='ico_radio'>선택</span>".$cate_menu[$c]."</label>";
				}
				?>
            </td>
        </tr>
    ...
    <div class="btn_confirm">
        ...
        <a href="./board.php?bo_table=<?php echo $bo_table ?>"><img src="<?php echo G5_URL ?>/img/write_cancel.png" alt="취소"/></a>
    </div>
	</form>
