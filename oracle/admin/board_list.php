		...
		<div id="admin_right_wrap">
			...
			<div class="tbl_head01 tbl_wrap">
				...
				<tr>
					...
					<th scope="col" class="ck_box"><?php echo subject_sort_link('bo_use_sns') ?>SNS<br>사용</a></th>
					<th scope="col" class="ck_box"><?php echo subject_sort_link('bo_use_search') ?>검색<br>사용</a></th>
					<th scope="col"><?php echo subject_sort_link('bo_order') ?>출력<br>순서</a></th>
					<th scope="col">접속기기</th>
					<th scope="col" class="th_last">관리</th>
				</tr>
				</thead>
				<tbody>
				<?php
				for ($i=0; $row=sql_fetch_array($result); $i++) {
					$one_update = '<a href="./board_form.php?w=u&amp;bo_table='.$row['bo_table'].'&amp;'.$qstr.'" class="btn">수정</a>';
					$one_copy = '<a href="./board_copy.php?bo_table='.$row['bo_table'].'" class="board_copy btn" target="win_board_copy">복사</a>';
