...
$sql ="select * from g5_write_online_consulting order by wr_datetime desc limit 0,5";
$result = sql_query($sql);

$sql2 ="select * from g5_write_online_consulting order by wr_datetime desc limit 0,5";
					...
					<div>
						...
						<div class="stats_chart">
							<div class="chart_title">
								<span>방문자 접속 통계</span>
								<a href="<?php G5_URL;?>/admin/visit.php"><i class="ri-add-line"></i></a>
							</div>
							<div class="chart">
								...
								<div class="circle_chart_text2">
									...
									<div><span style="margin-right: 255px;">이용기기 율 <small>(전일 기준)</small></span></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="content_box" id="online">
					<div class="stats_chart">
						<div class="chart_title">
							...
							<a href="<?php G5_URL;?>/admin/bbs/board.php?bo_table=online_consulting"><i class="ri-add-line"></i></a>
						</div>
						<div class="search">
								...
								<table>
									...
									<?php for ($i=0; $row=sql_fetch_array($result); $i++){ ?>
										<tr>
											<td>게시판</td>
											<td>온라인상담</td>
											<td><a href="<?php echo G5_URL ?>/admin/bbs/write.php?w=u&bo_table=online_consulting&wr_id=<?php echo $row['wr_id'] ?>"><?php echo $row['wr_subject']?></a></td>
