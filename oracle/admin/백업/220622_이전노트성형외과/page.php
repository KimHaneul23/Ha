...
<div class="right menu1_2">
				<div class="content_box">
					<div>
						<div class="title">
							<span>페이지별 접속 통계</span>
						</div>
					</div>
				</div>
					...
					<div class="stats_chart online">
						...
						<div class="chart">
							<div class="number_chart">
								<div>
									<div class="color_gray"><p>어제 방문자</p><span class="count">100</span></div>
									<div><p>오늘 방문자</p><span class="count">150</span></div>
								</div>
							</div>
					...
					<div class="search">
						...
						<div class="stats_chart page">
							<div class="chart_title wait_title">
								<span>페이지별 데이터 분석 <br><small>(전일 기준)</small></span>
				...
				<div class="content_box">
					<div class="search">
						...
						<div class="stats_chart">
							<div class="chart_title wait_title">
								<span>페이지별 유입경로 분석 <br><small>(전일 기준)</small></span>
