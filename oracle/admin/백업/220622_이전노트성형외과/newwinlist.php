    ...
    <div id="container" class="menu100_minheight">
		<div id="admin_right_wrap">
			...
			<div class="btn_add02 btn_add">
				<a href="./newwinform.php" id="cate_add">추가</a>
			</div>
			...
			<div class="tbl_head03">
				...
				<tr class="<?php echo $bg; ?>">
					...
					<td class="td_subject"><?php echo $row['nw_subject']; ?></td>
					...
					<td class="td_px"><?php echo $row['nw_disable_hours']; ?>시간</td>
					<td class="td_px"><?php echo $row['nw_left']; ?>px</td>
					<td class="td_px"><?php echo $row['nw_top']; ?>px</td>
					<td class="td_px"><?php echo $row['nw_width']; ?>px</td>
					<td class="td_px"><?php echo $row['nw_height']; ?>px</td>
					<td class="td_mngsmall">
						<a href="./newwinform.php?w=u&amp;nw_id=<?php echo $row['nw_id']; ?>" class="td_mngsmall_btn td_mngsmall_btn_left"><span class="sound_only"><?php echo $row['nw_subject']; ?> </span>수정</a>
						<a href="./newwinformupdate.php?w=d&amp;nw_id=<?php echo $row['nw_id']; ?>" onclick="return delete_confirm(this);" class="td_mngsmall_btn"><span class="sound_only"><?php echo $row['nw_subject']; ?> </span>삭제</a>
					</td>
				</tr>
				<?php
				}
