    ...
    <div id="container" class="menu100_minheight">
		<div id="admin_right_wrap">
			...
			<div style="text-align:center;margin-top:10px">
				<input type="image" src="<?php echo G5_URL ?>/img/adm_ok_btn.png" value="확인" accesskey="s">
				<a href="./newwinlist.php"><img src="<?php echo G5_URL ?>/img/adm_list_btn.png" alt="목록"></a>
			</div>
			</form>
		</div>
	</div>
