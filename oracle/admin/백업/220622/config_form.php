...
$pg_anchor = '<ul class="anchor">
	...
	<li><a href="#anc_cf_extra">회사정보</a></li>
...
<section id="anc_cf_basic">
    <div class="tbl_frm01 tbl_wrap">
        <table>
        	...
        	<tbody>
				<tr>
					<th scope="row"><label for="cf_4">상호명</label></th>
					<td colspan="3"><input type="text" name="cf_4" value="<?php echo get_sanitize_input($config['cf_4']); ?>" id="cf_4" class="frm_input" size="40"></td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_2">사업자등록번호</label></th>
					<td colspan="3"><input type="text" name="cf_2" value="<?php echo get_sanitize_input($config['cf_2']); ?>" id="cf_2" class="frm_input" size="40">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_5">주소</label></th>
					<td colspan="3"><input type="text" name="cf_5" value="<?php echo get_sanitize_input($config['cf_5']); ?>" id="cf_5" class="frm_input" size="70">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_1">대표자</label></th>
					<td colspan="3">
						<input type="text" name="cf_1" value="<?php echo get_sanitize_input($config['cf_1']); ?>" id="cf_1" class="frm_input" size="40">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_3">대표번호</label></th>
					<td colspan="3"><input type="text" name="cf_3" value="<?php echo get_sanitize_input($config['cf_3']); ?>" id="cf_3" class="frm_input" size="40">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_6">개인정보 보호책임자</label></th>
					<td colspan="3">
						<input type="text" name="cf_6" value="<?php echo get_sanitize_input($config['cf_6']); ?>" id="cf_6" class="frm_input" size="40">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_1_subj">월요일</label></th>
					<td colspan="3">
						<span class="frm_info">오전|오후|진료구분. | 로 구분</span>
						<input type="text" name="cf_1_subj" value="<?php echo get_sanitize_input($config['cf_1_subj']); ?>" id="cf_1_subj" class="frm_input" size="70">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_2_subj">화요일</label></th>
					<td colspan="3">
						<span class="frm_info">오전|오후|진료구분. | 로 구분</span>
						<input type="text" name="cf_2_subj" value="<?php echo get_sanitize_input($config['cf_2_subj']); ?>" id="cf_2_subj" class="frm_input" size="70">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_3_subj">수요일</label></th>
					<td colspan="3">
						<span class="frm_info">오전|오후|진료구분. | 로 구분</span>
						<input type="text" name="cf_3_subj" value="<?php echo get_sanitize_input($config['cf_3_subj']); ?>" id="cf_3_subj" class="frm_input" size="70">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_4_subj">목요일</label></th>
					<td colspan="3">
						<span class="frm_info">오전|오후|진료구분. | 로 구분</span>
						<input type="text" name="cf_4_subj" value="<?php echo get_sanitize_input($config['cf_4_subj']); ?>" id="cf_4_subj" class="frm_input" size="70">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_5_subj">금요일</label></th>
					<td colspan="3">
						<span class="frm_info">오전|오후|진료구분. | 로 구분</span>
						<input type="text" name="cf_5_subj" value="<?php echo get_sanitize_input($config['cf_5_subj']); ?>" id="cf_5_subj" class="frm_input" size="70">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_6_subj">토요일</label></th>
					<td colspan="3">
						<span class="frm_info">오전|오후|진료구분. | 로 구분</span>
						<input type="text" name="cf_6_subj" value="<?php echo get_sanitize_input($config['cf_6_subj']); ?>" id="cf_6_subj" class="frm_input" size="70">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="cf_title">홈페이지 타이틀</label></th>
...
<section id="anc_cf_board" style="display:none;">
...
<section id="anc_cf_join" style="display:none;">
