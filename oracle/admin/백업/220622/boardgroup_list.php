...
<div class="tbl_head01 tbl_wrap type02">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link('gr_id') ?>그룹아이디</th>
        <th scope="col"><?php echo subject_sort_link('gr_subject') ?>제목</th>
        <th scope="col"><?php echo subject_sort_link('gr_admin') ?>그룹관리자</th>
        <th scope="col">게시판</th>
        <th scope="col">접근<br>사용</th>
        <th scope="col">접근<br>회원수</th>
        <th scope="col"><?php echo subject_sort_link('gr_order') ?>출력<br>순서</th>
