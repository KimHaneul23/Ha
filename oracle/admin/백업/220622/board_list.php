...
<div class="tbl_head01 tbl_wrap type02">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link('a.gr_id') ?>그룹</th>
        <th scope="col"><?php echo subject_sort_link('bo_table') ?>TABLE</th>
        <th scope="col"><?php echo subject_sort_link('bo_skin', '', 'desc') ?>스킨</th>
        <th scope="col"><?php echo subject_sort_link('bo_mobile_skin', '', 'desc') ?>모바일<br>스킨</th>
        <th scope="col"><?php echo subject_sort_link('bo_subject') ?>제목</th>
        ...
        <th scope="col"><?php echo subject_sort_link('bo_use_sns') ?>SNS<br>사용</th>
        <th scope="col"><?php echo subject_sort_link('bo_use_search') ?>검색<br>사용</th>
        <th scope="col"><?php echo subject_sort_link('bo_order') ?>출력<br>순서</th>
