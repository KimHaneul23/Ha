...
$(document).ready(function(){
	var url1 = g5_url + "/admin/json/member_chart1.php";
	...
	$('.member_delete').click(function(){
		...
		$.ajax({
			url : g5_url + '/admin/json/member_delete.php',
			//dataType: 'json',
			data:{num:num},
			type: 'POST',
			success : function(data){
				alert(data);
				window.location.href = g5_url + '/admin/member_list.php';
			}
		});
	});
	...
	$('.chk_delete').click(function(){
		...
		$.ajax({
			url : g5_url + '/admin/json/member_chk_delete.php',
			//dataType: 'json',
			data:{code:code},
			type: 'POST',
			success : function(data){
...
function change_mb_3(num,mb_3){
	var mb_3 = $(mb_3).val();
	$.ajax({
		url : g5_url + '/admin/json/member_mb3_update.php',
		dataType: 'json',
...
function change_mb_sms(num,sms){
	...
	$.ajax({
		url : g5_url + '/admin/json/member_sms_update.php',
...
function change_mb_adult(num,adult){
	...
	$.ajax({
		url : g5_url + '/admin/json/member_adult_update.php',
...
function change_mb_mail(num,mail){
	...
	$.ajax({
		url : g5_url + '/admin/json/member_mail_update.php',
...
function member(today,yesterday){
	$.ajax({
		url : g5_url + '/admin/json/member_count2.php',
		dataType: 'json',
