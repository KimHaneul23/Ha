...
$(document).ready(function(){
	...
	$('.chk_delete').click(function(){
		...
		$.ajax({
			url : g5_url + '/admin/json/mng_chk_delete.php',
			//dataType: 'json',
			data:{code:code},
			type: 'POST',
			success : function(data){
				alert(data);
				 window.location.href = g5_url + '/admin/consul_mng.php';
			}
		});
	});
...
function change_wr_1(num,answer){
	...
	$.ajax({
		url : g5_url + '/admin/json/mng_update.php',
...
function change_wr_4(num,visit_num){
	...
	$.ajax({
		url : g5_url + '/admin/json/mng_update2.php',
