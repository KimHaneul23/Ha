...
$(document).ready(function(){
	$('.excel_button').click(function(){
			var date = $('.date').text();
			//console.log(date);
			location.href = g5_url + '/admin/json/chart.excel.php?yesterday='+date;
	});
	...
	//var url5 = g5_url + "/admin/json/chart5.json";
...
function page() {
	$.ajax({
		url : g5_url + '/admin/json/page_total.php',
		dataType: 'json',
		type: 'POST',
...
function visit(today,yesterday,one_month,three_month) {
	$.ajax({
		url : g5_url + '/admin/json/visit.php',
		dataType: 'json',
...
function mng(yesterday){
	$.ajax({
		url : g5_url + '/admin/json/index_mng_count.php',
		dataType: 'json',
		data:{yesterday:yesterday},
		type: 'POST',
		success : function(data){
...
setTimeout(function() {
	$.ajax({
		url : g5_url + '/admin/json/index_page.php',
		dataType: 'json',
		data:{device : device, st_date : st_date, ed_date : ed_date, page : page},
		type: 'POST',
		success : function(data){
			...
			// 페이징
			$.ajax({
				url : g5_url + '/admin/json/index_paging3.php',
				async : false,
				data:{device : device, st_date : st_date, ed_date : ed_date, total : total, page : page},
				type: 'POST',
				success : function(data){
...
setTimeout(function() {
	$.ajax({
		url : g5_url + '/admin/json/index_exit.php',
		dataType: 'json',
		data:{device : device, st_date : st_date, ed_date : ed_date, page : page},
		type: 'POST',
		success : function(data){
			...
			// 페이징
			$.ajax({
				url : g5_url + '/admin/json/index_paging4.php',
				async : false,
				data:{device : device, st_date : st_date, ed_date : ed_date, total : total, page : page},
				type: 'POST',
				success : function(data){
