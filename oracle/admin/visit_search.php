...
?>
<link href="<?php echo G5_URL?>/adm/css/admin.css" rel="stylesheet">

<style>
    .content_wrap{background:#f3f3f3 !important;}
    .visit_list_wrap{position:relative; width:82%; margin:80px 0 120px 280px; clear:both; }
    .local_sch01{clear:both; width:100%; padding: 0; /*background: #c5d4d2 !important;*/}
    .anchor{width:100%;}
    .tbl_head01{width:100%;}
    .local_sch{min-width:auto !important;}
    .local_sch select{height:34px;}
    .local_sch01 .frm_input{height:34px;}
    .local_sch01 .btn_submit{height:34px;}
    .local_sch01 > .local_sch01_from > a{display: inline-block; width:40px; height:33px; line-height:33px; background:#0f594e; color:#fff; text-align:center; font-weight:600; font-size:12px;}
    /*
...
<div class="local_sch local_sch01">
    <form name="fvisit" method="get" onsubmit="return fvisit_submit(this);" class="local_sch01_from">
    <?php echo $listall?>
...
<div class="tbl_wrap tbl_head01">
    ...
    <tr>
        <th scope="col">IP</th>
        <th scope="col" style="width:500px;">접속 경로</th>
