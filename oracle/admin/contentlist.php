...
<div id="wrapper">
	<div id="admin_menu_left">
		<?php include_once('./admin.menu.left500.php'); ?>
	</div>
		...
		<div id="admin_right_wrap">
			...
			<div class="tbl_head01 tbl_wrap">
				...
				<tr>
					<th scope="col">ID</th>
					<th scope="col">제목</th>
					<th scope="col" class="th_last_box">관리</th>
				</tr>
				</thead>
				<tbody>
				...
				<tr class="<?php echo $bg; ?>">
					...
					<td class="td_mng">
						<a href="./contentform.php?w=u&amp;co_id=<?php echo $row['co_id']; ?>" class="btn" style="margin-right:10px"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span>수정</a>
						<a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=<?php echo $row['co_id']; ?>" class="btn" style="margin-right:10px"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span> 보기</a>
						<a href="./contentformupdate.php?w=d&amp;co_id=<?php echo $row['co_id']; ?>" onclick="return delete_confirm(this);" class="btn"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span>삭제</a>
					</td>
				</tr>
				<?php
				}
