...
if($bo_table == 'notice_event'){
    goto_url(short_url_clean(G5_THEME_URL.'/sub/sub1_5.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else if($bo_table == 'youtube'){
    goto_url(short_url_clean(G5_THEME_URL.'/sub/sub1_6.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else if($bo_table == 'review'){
    goto_url(short_url_clean(G5_THEME_URL.'/sub/sub8_2.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else if($bo_table == 'text_review'){
    goto_url(short_url_clean(G5_THEME_URL.'/sub/sub8_3.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else {
