...
?>
<link rel="stylesheet" href="<?php echo G5_THEME_URL;?>/skin/board/online_consulting/style.css">
<!-- <div id="bo_title">
...
<section id="bo_w" >
    ...
    <div class="btn_confirm">
        ...
        <a href="<?php echo G5_BBS_URL.'/board.php?bo_table='.$bo_table ?>"><img src="<?php echo G5_URL ?>/img/write_cancel.png" alt="취소" style="height:33px;" /></a>
    </div>
	</form>
