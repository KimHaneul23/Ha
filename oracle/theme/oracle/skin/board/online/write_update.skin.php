...
$wr_13 = $_POST['wr_13'];
 ...
 $sql = " update g5_write_{$bo_table} set wr_11 = '{$wr_11}', wr_12 = '{$wr_12}', wr_13 = '{$wr_13}' where wr_id = '$wr_id' ";
	sql_query($sql);
...
if($is_admin && $type == 'admin'){
	alert("성공적으로 수정되었습니다.", '/admin/bbs/board.php?bo_table=online'); 
}else{
	goto_url('/bbs/board.php?bo_table=online#href_id');
}
?>
