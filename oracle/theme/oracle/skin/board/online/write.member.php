    ...
    <div class="bbs_head02 bbs_wrap online-consulting-form">
        ...
        <tr>
            ...
            <td <?php if($is_admin) echo "colspan='3'"; ?>>
				...
				if($w != 'u') {
				?>
				<input type="input" name="wr_1" id="wr_1" class="frm_input email_input" size="20" value="<?php echo $member_email[0]; ?>" maxlength="20">&nbsp;&nbsp;@&nbsp;&nbsp;
				<input type="input" name="wr_5" id="wr_5" class="frm_input email_input" size="20" value="<?php echo $member_email[1]; ?>" maxlength="20">
				<?php } else { ?>

				<input type="input" name="wr_1" id="wr_1" class="frm_input email_input" size="20" value="<?php echo $write['wr_1']; ?>" maxlength="20">&nbsp;&nbsp;@&nbsp;&nbsp;
