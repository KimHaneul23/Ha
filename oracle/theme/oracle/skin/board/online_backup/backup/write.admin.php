...
<section id="bo_w">
    ...
    <div class="bbs_head02 bbs_wrap">
        ...
        <tbody>
		<tr>
            <th scope="row"><label for="wr_name">이름</th>
            <td class="td_half"><?php echo $write['wr_name'] ?></td>
			<th scope="row"><label for="is_secret">공개여부</th>
            <td class="td_half">
				<?php 
				if($is_secret){
					echo "비공개";
        ...
        <tr>
            <th scope="row"><label for="wr_subject">제목</th>
            <td class="td_half"><?php echo $subject ?></td>
			<th scope="row"><label for="wr_subject">IP</th>
		...
		<tr>
			...
			<td class="td_half"><?php echo $write['wr_13']."@".$write['wr_5'];?></td>
        </tr>
        <?php if ($is_category) { ?>
        <tr>
            <th scope="row"><label for="ca_name">분류</th>
            <td colspan='3'"><?php echo $write['ca_name'];?></td>
        </tr>
        <?php } ?>
        <tr>
            <th scope="row"><label for="wr_content">내용</th>
    ...
    <div class="btn_confirm">
        ...
        <a href="./board.php?bo_table=<?php echo $bo_table ?>&page=<?=$page?>"><img src="<?php echo G5_URL ?>/img/list_list.png" alt="취소"/></a>
    </div>
	</form>
