...
<style>
    ...
    @media all and (max-width: 434px) { 
        ...
        .mb_hp_input{width:28%;}
        .bbs_head02 tbody td.bf_file_td .bf_file_text{width:100%;}
        #bo_w table tbody tr{display:inline-table;}
        .bbs_head02 tbody th {width:30%;}
        .bbs_head02 tbody td {width:70%;}
    }
</style>
<script>
    ...
    <div class="bbs_head02 bbs_wrap online-consulting-form">
        ...
        <!--<tr>
            ...
            <td <?php if($is_admin) echo "colspan='3'"; ?>>
				...
				//for($c=0; $c<$cnt; $c++){
				//	echo "<label class='cate_menu jijeom_chk'><input type='radio' name='ca_name' id='ca_name' required class='ca_name_radio jijeom_chk required' value='$cate_menu[$c]'";
				//	
        ...
        <tr>
            <th scope="row"><label for="ca_name">지점선택 <span style="color:red">*</span><strong class="sound_only">필수</strong></label></th>
            <td>
                <select name="ca_name" id="ca_name" required class="ca_name_box required" >
		...
		<tr>
			...
			<td>
				...
				<input type="input" name="wr_3" id="wr_3" class="frm_input mb_hp_input" size="10" value="<?php echo $member_hp[1]; ?>" maxlength="4">&nbsp;&nbsp;-&nbsp;&nbsp;
				<input type="input" name="wr_4" id="wr_4" class="frm_input mb_hp_input" size="10" value="<?php echo $member_hp[2]; ?>" maxlength="4">
				...
				<input type="input" name="wr_3" id="wr_3" class="frm_input mb_hp_input" size="10" value="<?php echo $write['wr_3']; ?>" maxlength="4">&nbsp;&nbsp;-&nbsp;&nbsp;
				<input type="input" name="wr_4" id="wr_4" class="frm_input mb_hp_input" size="10" value="<?php echo $write['wr_4']; ?>" maxlength="4">
        ...
        <tr>
            ...
            <td <?php if($is_admin) echo "colspan='3'"; ?>>
				...
				if($w != 'u') {
				?>
				<input type="input" name="wr_13" id="wr_13" class="frm_input email_input" size="20" value="<?php echo $member_email[0]; ?>" maxlength="20">&nbsp;&nbsp;@&nbsp;&nbsp;
				<input type="input" name="wr_5" id="wr_5" class="frm_input email_input" size="20" value="<?php echo $member_email[1]; ?>" maxlength="20">
				<?php } else { ?>

				<input type="input" name="wr_13" id="wr_13" class="frm_input email_input" size="20" value="<?php echo $write['wr_13']; ?>" maxlength="20">&nbsp;&nbsp;@&nbsp;&nbsp;
				<input type="input" name="wr_5" id="wr_5" class="frm_input email_input" size="20" value="<?php echo $write['wr_5']; ?>" maxlength="20">
				<?php } ?>
...
function fwrite_submit(f)
{
	...
	if (!agree2[0].checked) {
		alert("개인정보처리방침안내의 내용에 동의하셔야 상담글 등록을 하실 수 있습니다.");
		agree2[0].focus();
		return false;
	}
