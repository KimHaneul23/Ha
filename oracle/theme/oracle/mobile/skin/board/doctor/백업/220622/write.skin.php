		...
		<div class="main-content">
			...
			<div class="section">
						<div class="container">
							...
							<div class="theme-form mt-3">
								<span class="tit">직책</span>
								<div class='cont'>
									<input type="text" name="wr_1" value="<?php echo $write['wr_1']?>" id="wr_1" class="form-control field txt required" placeholder="직책" required>
								</div>
							</div>
							...
							<div class="theme-form mt-3">
								<div class="form-group">
								<span class="tit">팝업 썸네일 이미지</span>
								<div class="cont">
									<input type="file" name="bf_file[]" id="bf_file_<?php echo $i+2 ?>" title="파일첨부 <?php echo $i+2 ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="form-control field txt" style="line-height:32px;">
								</div>
								</div>
