...
<main id="content">
    ...
    <article class="sub_cont02 sub8_3_cont02 pd_100" id="text_review">
...
<script>
    ...
    $(function() {
        var location = document.querySelector("#text_review").offsetTop;
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h1 id="bo_v_title" class="p_r flex_row fd_c jc_center al_fe">
            <div class="text_review_text fz_22 ls_2 lh_16 medium ta_c">
                <?php if($view['is_notice']){ ?>
                <span class="text_review_text01">
                    [BEST]
                </span>
                <?php } ?>
                <span class="text_review_text01">
                ...
                <span class="text_review_text02">
                    <?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력 ?>
                </span>
            </div>
            <div class="fz_14 ls_2 lh_14 m_5" style="color:#7b7b7b;">20<?php echo date("y-m-d", strtotime($view['wr_datetime'])) ?></div>
    ...
    <div class="container-1280" id="bo_v_top">
        ...
        <ul class="bo_v_com">
			...
			<li><a href="<?php echo G5_THEME_URL ?>/sub/sub8_3.php#href_id"><p class="list_btn nanumgothic normal ta_c ls_p2">목록</p></a></li>
        </ul>
        <?php
