        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
            ...
            <td class="td_ranking">
                <div class="td_ranking_box">
                    <a href="<?=G5_URL ?>/admin/bbs/write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?=$list[$i][wr_id] ?>">
                        <p><span>1위</span> <?php echo $list[$i]['wr_1'] ?></p>
                        <p><span>2위</span> <?php echo $list[$i]['wr_3'] ?></p>
                        <p><span>3위</span> <?php echo $list[$i]['wr_5'] ?></p>
                        <p><span>4위</span> <?php echo $list[$i]['wr_7'] ?></p>
                        <p><span>5위</span> <?php echo $list[$i]['wr_9'] ?></p>
                    </a>
                </div>
            </td>
