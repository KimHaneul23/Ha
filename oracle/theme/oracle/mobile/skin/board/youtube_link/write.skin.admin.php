                        ...
                        <div class="comments-form">
							...
							<div class="theme-form mt-3">
								<div class="form-group">
									...
									<div class='cont'>
										<label><input type="radio" name="wr_1" value="Y" required <?php if($write['wr_1'] == 'Y' || $w != 'u') echo "checked='checked'"; ?> class="checkbox">&nbsp;Y</label>
										<label><input type="radio" name="wr_1" value="N" required <?php if($write['wr_1'] == 'N') echo "checked='checked'"; ?> class="checkbox">&nbsp;N</label>
									</div>
								</div>
							</div>
