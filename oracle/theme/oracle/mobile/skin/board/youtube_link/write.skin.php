                        ...
                        <div class="comments-form">
							...
							<div class="theme-form mt-3">
								<div class="form-group">
									...
									<div class='cont'>
										<label><input type="radio" name="wr_1" value="Y" required <?php if($write['wr_1'] == 'Y' || $w != 'u') echo "checked='checked'"; ?> class="checkbox"  style="display:inline-block; width:16px; min-width:auto; height:16px;">&nbsp;Y</label>
										<label><input type="radio" name="wr_1" value="N" required <?php if($write['wr_1'] == 'N') echo "checked='checked'"; ?> class="checkbox"  style="display:inline-block; width:16px; min-width:auto; height:16px;">&nbsp;N</label>
										<p class="fz_14 ls_2 lh_16 normal" style="color:#ff0000; margin-top:5px; padding:0;">★ 메인페이지에 보여지는 최대 노출 가능 개수는 5개입니다.</p>
									</div>
								</div>
							</div>
