...
//if($idx) {
//	$sql = "select * from g5_write_notice_event where wr_id = ".$idx;
//	$row = sql_fetch($sql);
...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="wr_5"> 
                <!--
                <label><input type="checkbox" name="wr_5[]" value="구월점" <?=$write['wr_5']?> <?php if($wr_5 == "구월점") echo " checked=checked"; ?>> 구월점</label>
                <label><input type="checkbox" name="wr_5[]" value="송도점" <?=$write['wr_5']?> <?php if($wr_5 == "송도점") echo " checked=checked"; ?>> 송도점</label>
                -->
				<input class="jijeom_chk" type="checkbox" name="wr_5" id="wr_5" value="구월점" <?php if($wr_5 == "구월점") echo " checked=checked"; ?>> <label for="wr_5">구월점</label>
                <input class="jijeom_chk" type="checkbox" name="wr_6" id="wr_6" value="송도점" <?php if($wr_6 == "송도점") echo " checked=checked"; ?>> <label for="wr_6">송도점</label>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="wr_1"> 
				...
				<input type="checkbox" name="wr_4" id="wr_4" value="Y"<?php if($wr_4 == "Y") echo " checked=checked";?>> <label for="wr_4">이벤트 시작전 게시</label>
            </td>
        </tr>
    ...
    <div class="btn_confirm">
        ...
        <a href="<?php echo G5_THEME_URL ?>/sub/sub1_5.php#href_id"><img src="<?php echo G5_URL ?>/img/cont_cencel.png" alt="취소" style="height:31px;" /></a>
    </div>
    </form>
