...
<div id="bo_gall">
    ...
    <ul id="gall_ul" >
		...
		<!-------------------------- 일반성형모드 리스트 화면 --------------------------->
		  ...
		  <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php if( $list[$i]['wr_3'] == 'mode_2') { echo 'display:none'; } ?>; width:45%; margin-top:10px ; float:left; padding:0 0 0 0;">
