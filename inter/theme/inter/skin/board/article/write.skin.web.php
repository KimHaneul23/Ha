    ...
    <article class="sub_top_cont sub1_3_top_cont" id="startContent">
        <div class="sub_top_cont_wrap">
            ...
            <div class="sub_top_text sub_titlebox ta_c">
                ...
                <p class="txt02 reveal fade-up delay_200 fz_40 ls_p3 lh_16 kopubworlddotum semibold">
                    올바른 치아 이야기 <br>
                    인터서울 아티클
                </p>
                <p class="txt03 reveal fade-up delay_400 fz_16 ls_p2 lh_16 kopubworlddotum normal">
        ...
        <div id="bo_w" class="">
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td>
                        <span class="frm_info" style="color:#ff0000; font-size:1rem; font-weight:600;">메인 노출은 최대 5개까지 가능하며 그 이상일 경우 최신순으로 5개까지 노출됩니다.</span>
                        <input type="checkbox" name="wr_3" value="Y" id="wr_3">
                ...
                <tr>
                    ...
                    <td>
                        <p class="frm_info fz_16 normal lh_16 m_5">이미지 크기는 <span style="color:#ff0000;">넓이 430픽셀 높이 560픽셀</span>로 해주세요.</p>
