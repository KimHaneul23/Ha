...
<div id="bo_w" class="">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <span class="frm_info" style="color:#ff0000; font-size:13px; font-weight:600;">메인 노출은 최대 10개까지 가능하며 그 이상일 경우 최신순으로 10개까지 노출됩니다.</span>
        ...
        <tr>
            <th scope="row"><?php echo ($i==0)?"리스트 썸네일":"뷰 썸네일"; ?></th>
            <td>
                <p class="frm_info fz_16 normal lh_16 m_5">이미지 크기는 <span style="color:#ff0000;">넓이 400픽셀 높이 400픽셀</span>로 해주세요.</p>
        ...
        <tr>
            <th scope="row">상단 <br>비주얼이미지 <br>PC</th>
            <td>
                <p class="frm_info fz_16 normal lh_16 m_5">이미지 크기는 <span style="color:#ff0000;">넓이 1920픽셀 높이 600픽셀</span>로 해주세요.</p>
        ...
        <tr>
            <th scope="row">상단 <br>비주얼이미지 <br>모바일</th>
            <td>
                <p class="frm_info fz_16 normal lh_16 m_5">이미지 크기는 <span style="color:#ff0000;">넓이 480픽셀 높이 480픽셀</span>로 해주세요.</p>
