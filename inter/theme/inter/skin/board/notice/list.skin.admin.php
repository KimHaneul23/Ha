...
<style>
    ...
    .primary-badge { background-color:#515c3e; padding:2px 4px; border-radius:3px; color:#fff; font-size:1rem; font-weight:400; }
</style>
				...
				<tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
					...
					<td class="td_img">
						<a href="./write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?=$list[$i][wr_id] ?>">
                            ...
                            if($thumb['src']) {
                                $img_content = '<img src="'.$thumb['ori'].'" alt="'.$thumb['alt'].'" style="width:220px; height:110px; object-fit:cover;">';
                            } else {
					...
					<td class="td_subject">
						<a href="./write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?=$list[$i][wr_id] ?>">
				            ...
				            <p style="width:auto; display:inline-block; color:#515c3e; font-size:1rem; font-weight:600;">[ 메인 노출 ]</p>
				            <?php } ?>
				            <?php
