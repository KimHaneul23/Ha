        ...
        <div id="bo_v">
            <div>
                <h1 id="bo_v_title" class="p_r flex_row jc_fe center">
                    <div class="review_text fz_17 lh_16 normal ta_c">
                        <span class="review_text01 medium">
                            [<?php echo $view['ca_name']; // 분류 출력 끝 ?>]
                        </span>&nbsp;
                        <span class="review_text02 normal">
                            <?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력 ?>
                        </span>
                    </div>
                    <div class="fz_17 lh_16 normal" style="color:#606060;">20<?php echo date("y-m-d", strtotime($view['wr_datetime'])) ?></div>
                </h1>
            </div>
            ...
            <div id="bo_v_atc">
                ...
                <!-- 본문 내용 시작 { -->
                <div id="bo_v_con"><?=$view['wr_content']; ?></div>
                <!-- } 본문 내용 끝 -->
                ...
                <div class="container-1280" id="bo_v_top">
                    ...
                    <ul class="bo_v_com">
                        <?php if ($is_admin) { ?>
                        <!--<?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>"><p class="list_btn fz_15 ls_p3 lh_16 medium ta_c">수정</p></a></li><?php } ?>
                        <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;"><p class="list_btn fz_15 ls_p3 lh_16 medium ta_c">삭제</p></a></li><?php } ?>
                        
                        <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>#href_id"><p class="list_btn fz_15 ls_p3 lh_16 medium ta_c">글쓰기</p></a></li><?php } ?>-->
                        <?php } ?>
                        <li><a href="<?php echo $list_href ?>#href_id"><p class="list_btn fz_15 ls_p3 lh_16 medium ta_c">목록</p></a></li>
                    </ul>
                    <?php
