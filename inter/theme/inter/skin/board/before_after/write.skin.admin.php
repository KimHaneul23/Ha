...
<div id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_1">Before 날짜 <span style="color:red">*</span><strong class="sound_only">필수</strong></label></th>
            <td>
                <p class="fz_14 ls_2 lh_16 normal m_5" style="color:#ff0000;">Ex ) 2012.10.29</p>
                <div id="autosave_wrapper">
                    <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input required" size="50" maxlength="255">
                </div>
            </td>
        ...
        <tr>
            <th scope="row"><label for="wr_2">After 날짜 <span style="color:red">*</span><strong class="sound_only">필수</strong></label></th>
            <td>
                <p class="fz_14 ls_2 lh_16 normal m_5" style="color:#ff0000;">Ex ) 2012.10.29</p>
                <div id="autosave_wrapper">
                    <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input required" size="50" maxlength="255">
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <p class="fz_14 ls_2 lh_16 normal m_5" style="color:#ff0000;">★ 이미지는 가로 : 320px , 세로 : 222px 로 등록해주시기 바랍니다.</p>
