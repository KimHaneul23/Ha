...
<link href="<?php echo G5_URL?>/skin/member/basic/style.css" rel="stylesheet">
...
<script>
    $(document).ready(function(){
        ...
        if (window_width <= 480) {
            $('.ht-inner').addClass('sub_header');// 로고 블랙
        } else {
...
<div id="reg_result" class="register">
    <a href="<?php echo G5_URL?>" class="pc_cont">
        <img class="reg_result_top_logo" src="<?php echo G5_THEME_URL?>/img/logo_b.png" alt="압구정 연세바로치과">
    </a>
    <p class="reg_result_welcome">
        WELCOME
    </p>
    ...
    <div class="result_bottom_txt">
        <p class="result_txt pc_cont_480">
        ...
        <div class="btn_confirm_reg">
            <a href="<?php echo G5_URL ?>/" class="reg_btn_submit">압구정 연세바로치과 메인으로</a>
        </div>
    </div>
