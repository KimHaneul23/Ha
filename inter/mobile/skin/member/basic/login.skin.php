...
<div class="mbskin_wrap">
    <div style="text-align:center; margin-bottom:30px;">
        <a href="<?php echo G5_URL?>" class="pc_cont_434">
            <img src="<?php echo G5_THEME_URL?>/img/logo_b.png" alt="압구정 연세바로치과">
        </a>
        <!--<p class="loging_top_text">세브란스병원 철학 그대로, 기본이 바로선 치과</p>-->
    </div>
    <div class="mbskin_box">
        ...
        <fieldset id="login_fs">
            ...
            <!--<p class="loging_bottom_text">회원가입 없이 간편 로그인</p>-->
        </fieldset> 
        </form>
